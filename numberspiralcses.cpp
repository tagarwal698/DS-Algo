...
int32_t main()
{
	...
	w(t) {
		vector <vector <int>> arr {{1, 2, 9, 10, 25}, {4, 3, 8, 11, 24}, {5, 6, 7, 12, 23}, {16, 15, 14, 13, 22}, {17, 18, 19, 20, 21}};
		vector <pair <int, int>> input;
		int temp1, temp2;
		for (int i = 0; i < t; i++) {
			cin >> temp1; cin >> temp2;
			input.pb(make_pair(temp1, temp2));
		}
		...
		for (int i = 0; i < t; i++) {
			cout << arr[input[i].first - 1][input[i].second - 1] << endl;
		}
	}
}